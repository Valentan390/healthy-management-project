...
`,eb=[{id:1,tool:"Матриця стейкхолдерів"},{id:2,tool:"SWOT аналіз"},{id:3,tool:"Bussines model canvas"},{id:4,tool:"Value proposition canvas"},{id:5,tool:"Customer journey map"}],tb=()=>c.jsx(Kw,{className:"container",children:c.jsxs(Jw,{children:[c.jsxs(qw,{children:["Бізнес ",c.jsx("span",{children:"інструменти"}),", які використувуємо в партнерстві"]}),c.jsx(Gw,{children:eb.map(e=>c.jsx(Zw,{children:e.tool},e.id))})]})}),pa="/healthy-management-project/assets/icon-footer-LwVBioNl.svg",nb=P.div`
  background-color: var(--background-bluedark);
`,rb=P.div`
  display: flex;
  padding: 40px 24px;
